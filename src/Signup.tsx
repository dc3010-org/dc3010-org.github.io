        ...
        <>
            <div className="app-baseline-layout">
                <header className="header">
                    ...
                    <h1 aria-label='signup-label'>Please fill out your details to create an account</h1>
                </header>
                <div className="w-25">
                    <h2 aria-label='email-label'>Email Address:</h2>
                    <h4 className="subtitle" aria-label='email-description-label'>The email address you will login with</h4>
                    <div className="input-group mb-3">
                        <input type="email" className="form-control" placeholder='e.g. EmailHandle@provider.com' aria-label='email-input' onChange={(e) => setEmail(e.target.value)}></input>
                    </div>
                    <h2 aria-label='password-label'>Password:</h2>
                    <h4 className="subtitle" aria-label='password-description-label'>The password for your account</h4>
                    <div className="input-group mb-3">
                        <input type="password" className="form-control" aria-label='password-input' onChange={(e) => setPassword(e.target.value)}></input>
                    </div>
                    <p className="fs-6 text-black" aria-label='password-rule-label'>(Minimum 6 characters long)</p>
                    <div className="input-group mb-3">
